...
public class ViewAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int professor = c.getColumnIndex("professor");
        titles.clear();
        ...
        if(c.moveToFirst())
        {
            do{
                ...
                stu.professor = c.getString(professor);
                stud.add(stu);

                titles.add(c.getString(id) + " \t " + c.getString(name) + " \t "  + c.getString(course) + " \t "  + c.getString(professor) );
        ...
        lst1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                i.putExtra("professor",stu.professor);
                startActivity(i);
            }
        });
